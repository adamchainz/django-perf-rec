...
class AllDBRecorderTests(TestCase):
    ...
    def test_records_all(self):
        ...
        assert callback.mock_calls == [
            mock.call(DBOp('replica', 'SELECT 1')),
            mock.call(DBOp('default', 'SELECT 2')),
            mock.call(DBOp('second', 'SELECT 3')),
        ]
